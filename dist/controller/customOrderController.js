...
exports.deleteCustomOrder = exports.updateCustomOrder = exports.getSIngleCustomOrder = exports.getUserCustomOrders = exports.getAllCustomOrders = exports.postCustomOrder = void 0;
...
const updateCustomOrder = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id: _id } = req.params;
    const customOrder = req.body;
    const updatedCustomOrder = yield customOrderModel_1.default.findByIdAndUpdate(_id, customOrder, { new: true });
    res.status(200).json(updatedCustomOrder);
    console.log("updated customOrder");
});
exports.updateCustomOrder = updateCustomOrder;
const deleteCustomOrder = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id: _id } = req.params;
    const deletedCustomOrder = yield customOrderModel_1.default.findByIdAndRemove(_id);
